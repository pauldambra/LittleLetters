...
public class BezierCurveWritingView extends View {
	    ...
	    switch (event.getAction()) {
	      ...
	      case MotionEvent.ACTION_UP:
	        ...
	        for (int i = 0; i < historySize; i++) {
	          ...
	          getCubicBezierPath(lastTouchPointX, lastTouchPointY, historicalX,
					historicalY);
	      ...
	      default:
	        Log.d(this.getClass().getName(),"Ignored touch event: " + event.toString());
	        return false;
	    }
	...
	private void getCubicBezierPath(double startX,
			double startY, float endX, float endY) {
		double[] touchPoints = new double[6];
		  ...
		  path.cubicTo((float) splineResult[3], (float) splineResult[4], (float) splineResult[6], (float) splineResult[7], endX, endY);
	}
